export interface CreateLogDTO {
  ...
  target_id?: string;
  target_type: "input" | "output" | "project" | "version" | "system" | "requirement_model" | "usecase" | "member" | "databases" | "tables" | "coulumn" | "relationship" | "testcases" | "activity_diagrams" | "usecase_diagrams" | "sequence_diagrams" ;
